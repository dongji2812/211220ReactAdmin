...
export default class Category extends Component {
            ...
            },
            {
                ...
                render: (category) => (//看Table文档，render是个函数。
                    <span>
                        ...
                        /* 点击后调用xx函数，传入的参数为本行category，调用时传入的参数为实参。 */}
    ...
    render() {
        ...
        //点击修改分类时会把当前行的category存到这里，刚开始没点击时category是没有值的，所以或上空对象，防止报错。
        ...
        return (
            <Card title={title} extra={extra}> {/* Card外不用套div。 */}
                <Table 
                    ...
                    //看table的API找到pagination，看到其为对象类型。再看pagination文档的API，找到defaultPageSize和showQuickJumper。
                />
                ...
                >
                    <UpdateForm
                        ...
                        //自己设置的categoryName属性。  render中读取了 点击修改分类函数调用时传入的实参该行category，所以可以取到它的name。
